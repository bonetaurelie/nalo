...
namespace OC\CoreBundle\Business;
...
class ContactService
{
     ...
     * @return bool
     */
    public function sendMail($subject = "Site NALO : message via la page contact", $sucessMessage = "Merci de nous avoir contacté, nous répondrons à vos questions dans les plus brefs délais.", $template = 'OCCoreBundle:Email:contact.html.twig')
    {
     ...
     * @param string $template
     */
    public function formTreatmentAndSendMail(Request $request, $subject = "Site NALO : message via la page contact", $sucessMessage = "Merci de nous avoir contacté, nous répondrons à vos questions dans les plus brefs délais.", $template = 'OCCoreBundle:Email:contact.html.twig'){
